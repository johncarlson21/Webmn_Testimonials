...
class Webmn_Testimonials_Block_Adminhtml_Testimony_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		public function __construct()
		{

				parent::__construct();
				$this->_objectId = "testimony_id";
		...
		{
				if( Mage::registry("testimony_data") && Mage::registry("testimony_data")->getId() ){

				    return Mage::helper("testimonials")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("testimony_data")->getId()));
